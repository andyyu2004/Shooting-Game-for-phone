...
function Player:drawHealth()
	...
	self.healthBar = display.newRect(self.group, display.contentCenterX, yText, 100*self.healthPercentage, 15)
...
function Player:deconstructor()
	...
	self.player.finalize = function()
		if self.player ~= nil then
			...
			Runtime:removeEventListener("enterFrame", self.fireSMG)
